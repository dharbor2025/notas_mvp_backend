...
// Este filtro es importante para manejar la seguridad de la aplicación,
// ya que asegura que cada solicitud HTTP esté autenticada y autorizada correctamente usando tokens JWT.
